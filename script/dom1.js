...
function docu_btn_func(){
    window.document.write("Hello JS")
}
function new_btn_func(){
    window.open("https://google.com", "_blank")
}
function size_btn_func(){
    window.open("https://google.com", "_blank", "width=500, height=500")
}
/*
    인라인 스크립트
    1. 함수, 변수 등 자바스크립트는 JS 파일내에서 작성
    2. 상호작용이 필요한 HTML 태그에 JS 연결을 위해서 태그 내에 이벤트(ex) onClink)등으로 함수 연결
